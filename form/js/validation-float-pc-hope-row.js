$(document).ready(function form_pc(){
    $('#pc_btn').click(function(){
        ...
        $('#pc_name, #pc_phone,#position2,#agree12').click(function(){
        ...
        if(error == false){
           ...
           $('#form_e12').prop("action", "https://docs.google.com/forms/u/0/d/e/1FAIpQLScUHmFvNymC872M9ytU1S1lUBEd6cq6YvTU3WEIk3johp7HhA/formResponse");
           $('#pc_btn').text('신청완료');
           $('.m_go_btn, #pc_btn').css({background:"#000"});
           
            
     $('.m_go_btn, #pc_btn').prop("disabled", false);
...
function dll3(){
    ...
    $('.m_go_btn, #pc_btn').prop("disabled", true);
//    hoa2();
}
            ...
            // {
                ...
                if( position != null )
                {
                    ...
                    if (agree == true)
                    {
                       ...
                       $('.m_go_btn, #pc_btn').css({background:"#ac9173"});
                       $('.m_go_btn, #pc_btn').css({cursor:"pointer"});
                    }
                    else
                    {
                        $('#pc_btn').css({transition:"1s"});
                        $('#pc_btn').prop("disabled", true);
                        $('#pc_btn').text("개인정보 동의를 해주세요");
                        $('#pc_btn').css({color:"#fff"});
                        $('.m_go_btn, #pc_btn').css({background:"#000"});
