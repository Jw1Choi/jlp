$(document).ready(function form_mob(){
    $('#mob_btn').click(function(){
        ...
        if(error == false){
           ...
           $('#form_e13').prop("action", "https://docs.google.com/forms/u/0/d/e/1FAIpQLScUHmFvNymC872M9ytU1S1lUBEd6cq6YvTU3WEIk3johp7HhA/formResponse");
